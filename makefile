...
MAGNETO:	$(OBJS)X.o $(OBJS)A.o  $(OBJS)B.o  $(OBJS)C.o  $(OBJS)D.o	\
                $(OBJS)E.o $(OBJS)F.o  $(OBJS)G.o  $(OBJS)H.o			\
		magneto.f90

		gfortran $(FFLAGS) -o MAGNETO					\
                $(OBJS)X.o $(OBJS)A.o  $(OBJS)B.o  $(OBJS)C.o  $(OBJS)D.o	\
		$(OBJS)E.o $(OBJS)F.o  $(OBJS)G.o  $(OBJS)H.o			\
		magneto.f90



$(OBJS)H.o:	H-error-mod.f90 $(OBJS)X.o $(OBJS)A.o
		gfortran $(FFLAGS) -c -o $(OBJS)H.o				\
		H-error-mod.f90 

$(OBJS)G.o:	G-evolve-mod.f90 $(OBJS)X.o $(OBJS)A.o $(OBJS)B.o 		\
		$(OBJS)C.o $(OBJS)D.o $(OBJS)E.o $(OBJS)F.o
		gfortran $(FFLAGS) -c -o $(OBJS)G.o				\
		G-evolve-mod.f90	

$(OBJS)F.o:	F-solve-mod.f90 $(OBJS)X.o $(OBJS)A.o $(OBJS)E.o
		gfortran $(FFLAGS) -c -o $(OBJS)F.o				\
		F-solve-mod.f90	

$(OBJS)E.o:	E-recon-mod.f90 $(OBJS)X.o $(OBJS)A.o $(OBJS)D.o
...
$(OBJS)X.o:	X-start-mod.f90
		gfortran $(FFLAGS) -c -o $(OBJS)X.o				\
		X-start-mod.f90
